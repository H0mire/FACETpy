...
FACETpy's adaptation of a dual-pathway autoencoder for EEG denoising.

Implementation and input
------------------------

The family is owned by ``facet.models.masterthesis.dpae``. The recorded adapter contract is
