...
A time-domain source separator with a dilated temporal convolutional network.

Implementation and input
------------------------

The family is owned by ``facet.models.masterthesis.conv_tasnet``. The recorded adapter contract is
