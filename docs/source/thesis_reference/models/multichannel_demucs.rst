...
A diagnostic Demucs extension using a target channel and two montage-selected neighbouring channels.

Implementation and input
------------------------

The family is owned by ``facet.models.experimental.v2.demucs_mc``. The recorded adapter contract is
