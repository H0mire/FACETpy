...
A source-separation Transformer with intra-chunk and inter-chunk attention.

Implementation and input
------------------------

The family is owned by ``facet.models.masterthesis.sepformer``. The recorded adapter contract is
