...
A waveform encoder and decoder with recurrent temporal processing.

Implementation and input
------------------------

The family is owned by ``facet.models.masterthesis.demucs``. The recorded adapter contract is
