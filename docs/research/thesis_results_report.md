...
| 4 | Nested-GAN | GAN (TF + time domain) | +13.54 | 0.9776 | 0.210 | — |
| 5 | DenoiseMamba | Sequence / SSM | +11.80 | 0.9664 | 0.257 | 93.39 % |
| 6 | IC-U-Net | Discriminative (CNN + ICA prior) | +11.77 | 0.9667 | 0.258 | 93.34 % |
| 7 | ViT-Spectrogram | Vision (MAE inpainting) | +11.60 | 0.9660 | 0.263 | 93.08 % |
| 8 | ST-GNN | Graph (spatial topology) | +11.00 | 0.9595 | 0.277 | ≈ 92 % |
| 9 | DPAE | Discriminative (dual-pathway CNN) | +7.48 | 0.9132 | 0.423 | 82.12 % |
| 10 | D4PM | Diffusion | (+3.21)\* | 0.7251 | 0.699 | — |
| 11 | DHCT-GAN v2 | GAN (hybrid CNN + Transformer) | +1.69 | 0.5673 | 0.824 | 32.17 % |
...
1. **Audio-derived source-separation architectures dominate.** All three audio
   ...
   artifact problem.
2. **A "discriminative + sequence + vision + graph" middle plateau exists at
...
3. **Input contract matters more than architecture family.** The DHCT-GAN v1
