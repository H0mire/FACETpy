...
# ---------------------------------------------------------------------------
_candidates = sorted(
    glob("./training_output/cascadedcontextdenoisingautoencoderniazyprooffit_*/exports/cascaded_context_dae.ts")
)
if not _candidates:
    raise FileNotFoundError(
        "No cascaded_context_dae TorchScript checkpoint found. Train the model first (see header comment)."
    )
