...
| `unified_holdout.inference_seconds` | 101.119253 |
...
| `unified_holdout.rms_recovery_distance` | 0.684989 |
| `unified_holdout.rms_recovery_ratio` | 0.403698 |
...
```json
{
  "unified_holdout": {
    ...
    "rms_recovery_ratio": 0.40369847416877747,
    "rms_recovery_distance": 0.6849888563156128,
