...
PROFILES = [
    dict(
        ...
        config="base filters 32 · latent filters 128 · artifact target", result="Run 7 pipeline: 4.13 µV GA residual", sources=["src/facet/models/dpae_deployment_edition/training.py","src/facet/models/dpae_deployment_edition/training_niazy_proof_fit_seed45.yaml"]),
    dict(
        ...
        config="dropout 0.2 · batch 128 · artifact target", result="Run 7 pipeline: 4.05 µV GA residual", sources=["src/facet/models/cascaded_dae_deployment_edition/training.py","src/facet/models/cascaded_dae_deployment_edition/training_niazy_proof_fit_seed45.yaml"]),
    dict(
        ...
        config="7-epoch context · dropout 0.2 · artifact target", result="Run 7 pipeline: 3.08 µV GA residual", sources=["src/facet/models/cascaded_context_dae_deployment_edition/training.py","src/facet/models/cascaded_context_dae_deployment_edition/training_niazy_proof_fit_seed45.yaml"]),
    dict(
        ...
        config="n_sources 2 · masks sigmoid · artifact source index 1", result="Run 7 pipeline: 3.39 µV GA residual", sources=["src/facet/models/conv_tasnet_deployment_edition/training.py","src/facet/models/conv_tasnet_deployment_edition/training_niazy_proof_fit_seed45.yaml"]),
    dict(
        ...
        config="lr 1e−3 · initial channels 64 · SI-SDR weight 0", result="Run 8: 1.89 µV GA residual", sources=["src/facet/models/demucs_deployment_edition/training.py","src/facet/models/demucs_deployment_edition/training_niazy_proof_fit.yaml","output/run8_fetched/gridpod4/grids/run8/grid_demucs_screen.json"]),
    dict(
        ...
        config="2 dual-path blocks · dFF 256 · 7-epoch context", result="Run 7 pipeline: 2.43 µV GA residual", sources=["src/facet/models/sepformer_deployment_edition/training.py","src/facet/models/sepformer_deployment_edition/training_niazy_proof_fit_seed45.yaml"]),
    dict(
        ...
        config="7-epoch context configuration · artifact target", result="Run 7 pipeline: 4.08 µV GA residual", sources=["src/facet/models/denoise_mamba_deployment_edition/training.py","src/facet/models/denoise_mamba_deployment_edition/training_niazy_proof_fit_ctx_epochs_seed45.yaml"]),
    dict(
        ...
        config="200 diffusion steps · d_model 128 · waveform fraction 0.25", result="Run 7 pipeline: 2.82 µV GA residual", sources=["src/facet/models/d4pm_deployment_edition/training.py","src/facet/models/d4pm_deployment_edition/training_niazy_proof_fit_seed45.yaml"]),
    dict(
        ...
        config="lr 1.5e−4 · inner channels 48 · SI-SDR weight 1", result="Run 8: 0.974 µV GA residual", sources=["src/facet/models/nested_gan_deployment_edition/training.py","src/facet/models/nested_gan_deployment_edition/training_niazy_proof_fit.yaml","output/run8_fetched/gridpod1/grids/run8/grid_nested_gan_screen.json"]),
    dict(
        ...
        config="lr 1e−3 · embed dim 192 · SI-SDR weight 1", result="Run 8: 2.222 µV GA residual", sources=["src/facet/models/vit_spectrogram_deployment_edition/training.py","src/facet/models/vit_spectrogram_deployment_edition/training_niazy_proof_fit.yaml","output/run8_fetched/gridpod2/grids/run8/grid_vit_spectrogram_screen.json"]),
    dict(
        ...
        config="base channels 16 · depth 4 · heads 4 · Run 8: 2/27 only", result="Run 7: 2.44 µV GA residual", note="The incomplete Run 8 grid is not used for selected-variant claims.", sources=["src/facet/models/dhct_gan_deployment_edition/training.py","src/facet/models/dhct_gan_deployment_edition/training_niazy_proof_fit_seed45.yaml","output/run8_fetched/gridpod3/grids/run8/grid_dhct_gan_screen.json"]),
    dict(
        ...
        config="30 channels · 7 epochs · ICA + base channels 64", result="Run 7: 4.56 µV GA residual; output discontinuity", note="Diagnostic only: not retained as a valid correction result.", sources=["src/facet/models/ic_unet_deployment_edition/training.py","src/facet/models/ic_unet_deployment_edition/training_niazy_proof_fit_seed45.yaml"]),
    dict(
        ...
        config="hidden channels 16 · Chebyshev order 3 · kNN=4", result="Run 7: 0.57 µV GA residual; staircase output", note="Diagnostic only: low residual is invalidated by the discontinuity check.", sources=["src/facet/models/st_gnn_deployment_edition/training.py","src/facet/models/st_gnn_deployment_edition/training_niazy_proof_fit_seed45.yaml"]),
]
