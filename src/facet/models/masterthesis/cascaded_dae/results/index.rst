...
Recorded results for ``cascaded_dae``.
...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/cascaded_dae/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - Experiment
     ...
     - Files
     - Recorded status
   * - ``holdout_cascaded_dae``
     - Phase 1; training: ``proof_fit``; evaluation: ``proof_fit``
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/cascaded_dae/results/holdout_cascaded_dae/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/cascaded_dae/results/holdout_cascaded_dae/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/cascaded_dae/results/holdout_cascaded_dae/training_curve.svg>`
