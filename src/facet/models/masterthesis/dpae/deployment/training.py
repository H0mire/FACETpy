"""DPAE deployment edition.

**What the base edition does on a real recording.** 195.8 µV residual gradient artifact against FARM's 4.62 — worse than no correction at all.
...
imported unchanged from :mod:`facet.models.masterthesis.dpae.training`.
...
from facet.models.masterthesis.dpae.training import build_model as _build_core
