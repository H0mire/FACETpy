...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/dpae/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - ``holdout_dpae``
     ...
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/dpae/results/holdout_dpae/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/dpae/results/holdout_dpae/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/dpae/results/holdout_dpae/training_curve.svg>`
