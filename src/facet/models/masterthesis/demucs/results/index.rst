...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/demucs/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - ``holdout_demucs``
     ...
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/demucs/results/holdout_demucs/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/demucs/results/holdout_demucs/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/demucs/results/holdout_demucs/training_curve.svg>`
