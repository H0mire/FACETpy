...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/ic_unet/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - ``holdout_ic_unet``
     ...
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/ic_unet/results/holdout_ic_unet/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/ic_unet/results/holdout_ic_unet/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/ic_unet/results/holdout_ic_unet/training_curve.svg>`
