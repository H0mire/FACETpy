...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/d4pm/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - ``holdout_d4pm``
     ...
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/d4pm/results/holdout_d4pm/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/d4pm/results/holdout_d4pm/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/d4pm/results/holdout_d4pm/training_curve.svg>`
