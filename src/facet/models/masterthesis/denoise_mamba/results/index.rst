...
Recorded results for ``denoise_mamba``.
...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/denoise_mamba/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - Experiment
     ...
     - Files
     - Recorded status
   * - ``holdout_denoise_mamba``
     - Phase 1; training: ``proof_fit``; evaluation: ``proof_fit``
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/denoise_mamba/results/holdout_denoise_mamba/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/denoise_mamba/results/holdout_denoise_mamba/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/denoise_mamba/results/holdout_denoise_mamba/training_curve.svg>`
