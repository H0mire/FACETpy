...
Recorded results for ``dhct_gan_v2``.
...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/dhct_gan/v2/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - ``holdout_dhct_gan_v2``
     ...
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/dhct_gan/v2/results/holdout_dhct_gan_v2/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/dhct_gan/v2/results/holdout_dhct_gan_v2/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/dhct_gan/v2/results/holdout_dhct_gan_v2/training_curve.svg>`
