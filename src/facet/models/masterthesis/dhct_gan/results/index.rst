...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/dhct_gan/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - ``holdout_dhct_gan``
     ...
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/dhct_gan/results/holdout_dhct_gan/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/dhct_gan/results/holdout_dhct_gan/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/dhct_gan/results/holdout_dhct_gan/training_curve.svg>`
