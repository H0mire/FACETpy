...
Recorded results for ``dhct_gan_strict_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/dhct_gan/strict/results/manifest.json>`.
