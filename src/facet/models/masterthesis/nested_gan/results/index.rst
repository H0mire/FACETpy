...
Recorded results for ``nested_gan``.
...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/nested_gan/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - ``holdout_nested_gan``
     ...
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/nested_gan/results/holdout_nested_gan/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/nested_gan/results/holdout_nested_gan/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/nested_gan/results/holdout_nested_gan/training_curve.svg>`
