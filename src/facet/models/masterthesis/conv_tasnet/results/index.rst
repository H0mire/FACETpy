...
Recorded results for ``conv_tasnet``.
...
:download:`Manifest and source associations </../../src/facet/models/masterthesis/conv_tasnet/results/manifest.json>`.
...
.. list-table:: Recorded experiments
   ...
   * - ``holdout_conv_tasnet``
     ...
     - :download:`Hyperparameters </../../src/facet/models/masterthesis/conv_tasnet/results/holdout_conv_tasnet/hyperparameters.yaml>`; :download:`Evaluation </../../src/facet/models/masterthesis/conv_tasnet/results/holdout_conv_tasnet/evaluation.json>`; :download:`Training curve (SVG) </../../src/facet/models/masterthesis/conv_tasnet/results/holdout_conv_tasnet/training_curve.svg>`
