...
Recorded results for ``d4pm_paper_accurate_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/experimental/paper_accurate/d4pm/results/manifest.json>`.
