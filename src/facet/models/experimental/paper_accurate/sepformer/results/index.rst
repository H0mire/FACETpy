...
Recorded results for ``sepformer_paper_accurate_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/experimental/paper_accurate/sepformer/results/manifest.json>`.
