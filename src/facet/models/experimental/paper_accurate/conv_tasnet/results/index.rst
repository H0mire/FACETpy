...
Recorded results for ``conv_tasnet_paper_accurate_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/experimental/paper_accurate/conv_tasnet/results/manifest.json>`.
