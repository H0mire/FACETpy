...
Recorded results for ``dhct_gan_paper_accurate_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/experimental/paper_accurate/dhct_gan/results/manifest.json>`.
