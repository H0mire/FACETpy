...
Recorded results for ``vit_spectrogram_paper_accurate_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/experimental/paper_accurate/vit_spectrogram/results/manifest.json>`.
