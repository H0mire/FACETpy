...
Recorded results for ``nested_gan_paper_accurate_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/experimental/paper_accurate/nested_gan/results/manifest.json>`.
