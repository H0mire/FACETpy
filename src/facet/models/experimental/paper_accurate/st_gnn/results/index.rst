...
Recorded results for ``st_gnn_paper_accurate_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/experimental/paper_accurate/st_gnn/results/manifest.json>`.
