...
Recorded results for ``dhct_gan_v2_paper_accurate_edition``.
...
:download:`Manifest and source associations </../../src/facet/models/experimental/paper_accurate/dhct_gan_v2/results/manifest.json>`.
