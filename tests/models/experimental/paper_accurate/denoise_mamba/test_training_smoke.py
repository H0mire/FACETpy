...
def _tiny_model(torch):
    from facet.models.experimental.paper_accurate.denoise_mamba.training import build_model
...
def test_build_dataset_clean_target(tmp_path):
    pytest.importorskip("torch")
    from facet.models.experimental.paper_accurate.denoise_mamba.training import build_dataset
